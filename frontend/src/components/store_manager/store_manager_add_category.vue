                ...
                <div class="card-body rounded" style="background-color: wheat;">
                    ...
                    <div style="margin-top: 30px;">
                        ...
                        <button class="btn btn-outline-secondary"
                            @click="$router.push(`/store_manager/categories`)">Cancel</button>
                    </div>
                </div>
            </div>
        </form>
...
<script>
    ...
    export default {
        name: "Store_Manager_Add_Category",
        components: {
            Store_Manager_Nav,
            Un_Authorized,
            Page_Not_Found
        ...
        methods: {
            async add(e){
                ...
                let url=`http://127.0.0.1:5000/api/store_manager/${sm_id}/category`
