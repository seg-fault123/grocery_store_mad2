<template>
    <div class="container" style="background-color: wheat; padding: 10px; margin-top: 20px; border-radius: 10px;">
        <h2 style="padding: 10px;">Welcome to the Store Manager SignUp Page</h2>
        <br>
        ...
        <div class="container" id="links" style="margin-top: 60px;">
            <div class="row">
                ...
                <div class="col">
                    <div class="badge bg-dark">
                        <h5>Registered Store Manager?</h5>
    ...
    export default{
        ...
        methods: {
            async create_account(e){
                ...
                let resp=await fetch("http://127.0.0.1:5000/api/store_manager", {
                    method: "POST",
                    headers: {
